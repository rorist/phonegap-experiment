...
public class App extends DroidGap {
    ...
    // private static final String EVT_START =
    // "{start: {type: 'start',touches: [{clientX: %f,clientY: %f}, {clientX: %f,clientY: %f}]}}";
    // private static final String EVT_MOVE =
    // "{move: {type: 'move',touches: [{clientX: %f,clientY: %f}, {clientX: %f,clientY: %f}]}}";
